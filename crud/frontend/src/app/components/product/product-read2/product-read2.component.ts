...
export class ProductRead2Component implements AfterViewInit {
  //decorators: @ViewChild que são filho da tela (da view) sobre a variavel paginator
  //então o proprio angular irá percorrer, através do componente (var) declaro no html #paginator
